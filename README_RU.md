...
- **Показ популярного и трендов:** Показывать видео с наибольшим количеством взаимодействий в регионе пользователя.
- **Выбор категорий:** Показывать пользователю форму, где он может выбрать интересующие темы.
Диверсифицированная выдача: Смешивание в первой сессии контента разных категорий для быстрого прощупывания интересов пользователя через его первые клики.
### Новые видео

Новые видео надо как-то бустить в выдачу чтобы они нашли свою ца и собирали действия иначе они всегда останутся холодными
